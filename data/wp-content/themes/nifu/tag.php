...
<div id="content">
<?php the_post(); ?>
<h1 class="page-title"><?php _e( 'Tag Archives for', 'nifu' ) ?> <span><?php single_tag_title() ?></span></h1>
<?php rewind_posts(); ?>
...
<span class="meta-sep"> | </span>
<?php if ( $nifu_tags = nifu_tags(', ') ) : // ?>
<span class="tag-links"><?php printf( __( 'Also tagged %s', 'nifu' ), $nifu_tags ) ?></span>
<?php endif; ?>
